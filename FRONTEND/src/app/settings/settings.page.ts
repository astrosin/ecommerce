...
export class SettingsPage implements OnInit {
  ...
  items = [
    { name: 'Notifications', url: 'notificationsettings' },
  ...
  constructor(private navCtrl: NavController, private fun: FunctionsService, private menuCtrl: MenuController, private page: NavController, private dataService: AuthServiceService, private modalController: ModalController) { }
